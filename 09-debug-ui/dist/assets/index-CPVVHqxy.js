...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ii,depthTest:!1,depthWrite:!1})}function mc(){return new li({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ol(),fragmentShader:`
		...
		`,blending:ii,depthTest:!1,depthWrite:!1})}function _c(){return new li({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ol(),fragmentShader:`
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	...
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new Lv(this,t,e,n)}addFolder(t){const e=new wl({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof Xa||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof Xa)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=s=>{s.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const i=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=i+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}const Zo=new wl({width:300,title:"Debug UI by jeandv",closeFolders:!1});window.addEventListener("keydown",r=>{r.key=="h"&&Zo.show(Zo._hidden)});const gn={},Lu=document.querySelector("canvas.webgl"),Rl=new af;gn.color="#fffff";const Bv=new Gi(1,1,1,2,2,2),Cl=new al({color:gn.color}),ki=new Tn(Bv,Cl);Rl.add(ki);const Lr=Zo.addFolder("Mi cubito");Lr.add(ki.position,"y").min(-3).max(3).step(.01).name("elevation");Lr.add(ki,"visible");Lr.add(Cl,"wireframe");Lr.addColor(gn,"color").onChange(r=>{Cl.color.set(gn.color)});gn.spin=()=>{Du.to(ki.rotation,{y:ki.rotation.y+Math.PI*2})};Lr.add(gn,"spin");gn.subdivision=2;Lr.add(gn,"subdivision").min(1).max(20).step(1).onFinishChange(()=>{ki.geometry.dispose(),ki.geometry=new Gi(1,1,1,gn.subdivision,gn.subdivision,gn.subdivision)});const Sn={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{Sn.width=window.innerWidth,Sn.height=window.innerHeight,ui.aspect=Sn.width/Sn.height,ui.updateProjectionMatrix(),es.setSize(Sn.width,Sn.height),es.setPixelRatio(Math.min(window.devicePixelRatio,2))});const ui=new an(75,Sn.width/Sn.height,.1,100);ui.position.x=1;ui.position.y=1;ui.position.z=2;Rl.add(ui);const Uu=new Qg(ui,Lu);Uu.enableDamping=!0;const es=new jg({canvas:Lu});es.setSize(Sn.width,Sn.height);es.setPixelRatio(Math.min(window.devicePixelRatio,2));const zv=new ff,Iu=()=>{zv.getElapsedTime(),Uu.update(),es.render(Rl,ui),window.requestAnimationFrame(Iu)};Iu();
//# sourceMappingURL=index-CPVVHqxy.js.map
